...
namespace exemplo_crud
{
    ...
    {
        servidor = "127.0.0.1";
        /*127.0.0.1 - número do servidor local ou seja o proprio
        computador, para conexões online necessário colocar
        o numero do servidor na internet*/
        database = "crud_csharp";
        //Database que iremos criar futuramente
        usuario = "root";
        senha = "";
        /*Usuário e senha são padrões (root e senha branco)
        para conexões remota necessário substituirpor usuário
        e senha fornecido*/
